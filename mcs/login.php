...
if(isset($_POST['login']))
{
	...
	$stmt = $con->query('SELECT * FROM `users` WHERE `username` = ' . $con->quote($user) . ' OR `e-mail` = ' . $con->quote($user));
	...
	else echo '<div id="content"><div id="content-head">Vead</div><div id="content-box">'.$vead.'</div></div><br>';
}
?>
<div class="row-fluid">
	<div class="span12">
