...
<div class="row-fluid">
	...
	{
		echo '<b>Serveri koduleht:</b> <a href="'.$query_info['server_info1'].'">'.$query_info['server_info1'].'</a><br>';
	}
	if(!empty($query_info['server_info2']))
	{
		echo '<b>Informatsioon:</b><br>'.$query_info['server_info2'].'<br>';
	}
	?>
	<br><center><img src="http://s.staatus.eu/chart.php?server_id=<?php echo $INFO_SERVER_ID; ?>"><br><br>
	<span style="border: 1px solid grey; background-color: lightgrey; padding: 2px; border-radius: 5px;">[IMG]http://s.staatus.eu/chart.php?server_id=<?php echo $INFO_SERVER_ID; ?>[/IMG]</span></center><br>
	<br>
	</div>
	<div class="span4">
              <p>
