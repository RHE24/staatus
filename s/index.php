...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Staatus &bull; Serverid</title>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <a class="brand" href="?page=index">Serverid</a>
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
			  ...
			  <?php if($_SESSION['logged'] == true) { ?><li><a href="?page=addserver">Lisa mänguserver</a></li><?php } ?>
